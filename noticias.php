     ...
     <div class="d-none d-sm-block">
        <div class="row">
            ...
            <div class="col-md-12 mt-3">
                ...
                <div class="row mt-2">
                    <div class="col-md-4">
                        <img src="https://www.acheisudoeste.com.br/hd-imagens/noticias/6907-achei-sudoeste-manifestacao-alunos-ceep-em-brumado.webp" class="img-fluid" height="50px">
                    </div>
                    <div class="col-md-8">
                    <div class="text-center"><h2>Manisfetação</h2></div>
                ...
                <div class="row mt-2">
                    <div class="col-md-4">
                        <img src="https://cdn.arede.info/img/cover/530000/CEEP2_00538972_0_202409171204.jpg?xid=1844228" class="img-fluid" height="50px">
                    </div>
                    <div class="col-md-8">
                    <div class="text-center"><h2>Ceep Demolido</h2></div>
